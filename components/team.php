...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <title>Sport Store/Команда</title>
  </head>
  <body>
    <div class="list_registration_team TEXT_text">
        <div class="team_conteiner">
            <div class="team_content">
                <div class="team_top">
                    <div class="team_img">
                        <img src="../img/Anastasia.png" alt="">
                    </div>
                    <div class="knopka TEXT_podzagolovok">Галина П. П.</div>
            ...
            <div class="team_content">
                <div class="team_top">
                    <div class="team_img">                        
                        <img src="../img/Garry.png" alt="">
                    </div>
                    <div class="knopka TEXT_podzagolovok">Harry P. P.</div>
            ...
            <div class="team_content">
                <div class="team_top">
                    <div class="team_img"> 
                        <img src="../img/Hugrid.png" alt="">
                    </div>
                    <div class="knopka TEXT_podzagolovok">Хагрид В. А.</div>
